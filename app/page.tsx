...
export default function Home() {
  ...
  return (
    <div>
      <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-3 dark:bg-neutral-800 dark:border-neutral-700">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <div className='flex items-center cursor-pointer' onClick={() => router.push("/")}>
                ...
                <h2 className='font-bold text-lg'>FrameFlow</h2>
              </div>
            </div>
          </div>
          <div id="navbar-collapse-with-animation" className="hs-collapse overflow-hidden transition-all duration-300 basis-full grow">
            <div className="flex flex-row items-center justify-end sm:ps-7">

              {!user?.user?.email ? <Authentication>
                <div className="flex items-center gap-x-2 font-medium text-gray-500 hover:text-blue-600 sm:border-s sm:border-gray-300 py-2 sm:py-0 sm:ms-4 sm:my-3 sm:ps-6 dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-blue-500 cursor-pointer" >
